...
4. **Design System**: Use a paleta definida no CSS: `bg-primary` para botões principais do cliente (azul padrão TYT `#0A4275` ou similar) e tons secundários limpos. O layout deve respeitar os componentes Shadcn instalados em `src/components/ui`.
